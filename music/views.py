...
from api.models import LikeSong, DislikeSong, Comment
...
class ArtistDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['albums'] = Album.objects.filter(artist=context['artist'])
        context['songs'] = Song.objects.filter(album__in={x for x in context['albums']})
        context['song_num'] = len(context['songs'])
        return context
